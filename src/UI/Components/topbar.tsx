    ...
    <div>
      ...
      >
        <button onClick={() => setIsOpen(!isOpen)}>
          <img
            src="/hamburgerbutton.png"
            alt="Menu"
            className="w-8 h-8 mt-1.5 mr-4"
          />
        </button>
      </nav>
      ...
      <div className={`sidebar ${isOpen ? "open" : ""} md:hidden`}>
        <div className="fixed top-0 left-0 w-full h-full bg-[#1B1B1B] p-4 overflow-auto ">
          ...
          <nav
            className="md:hidden fixed right-0 top-0 m-4"
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-4 text-xl underline ">
              <li>
                <a href="/support" className="text-white flex">
                  <img
                    src="/support.png"
                    alt="Support"
              ...
              <li>
                <a href="/subscribe" className="text-white flex -ml-1.5ww">
                  <img
                    src="/subscribe.webp"
                    alt="Subscribe"
                    className="h-10 w-10 mr-2 -mt-1.5 -ml-1.5"
                  />
                  Subscribe
                </a>
              </li>
              <li>
                <a href="/settings" className="text-white flex">
                  <img
                    src="/settings.png"
                    alt="Settings"
                    className="h-8 w-8 mr-2 -mt-0.5"
          ...
          <div className="flex items-center py-3 ml-5">
            ...
            <nav className="hidden md:flex" style={{ marginLeft: "auto" }}>
              <ul className="flex space-x-4 text-xl underline">
                <li>
                  <a href="/support" className="text-white px-4 flex">
                    <img
                      src="/support.png"
                      alt="Support"
                      className="h-8 w-8 mr-2 -mt-0.5"
                ...
                <li>
                  <a href="/subscribe" className="text-white px-4 flex">
                    <img
                      src="/subscribe.webp"
                      alt="Subscribe"
                ...
                <li>
                  <a href="/settings" className="text-white px-4 flex">
                    <img
                      src="/settings.png"
                      alt="Settings"
                      className="h-8 w-8 mr-2 -mt-0.5"
