...
export default function Home() {
    ...
    return (
        <main className="flex items-center justify-center h-screen bg-gradient-to-t from-gray-custom-light to-gray-custom">
              ...
              {/* Navigation bar */}
              <nav className="md:hidden fixed top-0 right-0 m-4" style={{ marginLeft: 'auto' }}>
                <button onClick={() => setIsOpen(!isOpen)}>
                  <img src="/hamburgerbutton.png" alt="Menu" className="w-8 h-8 mt-1.5 mr-4" />
                </button>
              </nav>

              {/* Sidebar that is reactive*/}
              <div className={`sidebar ${isOpen ? 'open' : ''}`}> // uses the sidebar.css file
